...
var canonicalTargets = []Target{
	{
		...
		Slice:          "pi-dev",
		DefaultProfile: "meta",
		Description:    "Work on Pi config + agent architecture",
	...
	},
	{
		...
		Slice:          "research",
		DefaultProfile: "meta",
		Description:    "Docs + external retrieval + recon",
	...
	},
	{
		...
		Description:    "Implement + verify + governance",
	...
	},
	{
		...
		Slice:          "delivery",
		DefaultProfile: "ship",
		Description:    "Delivery with stronger completion posture",
	...
	},
	{
		...
		Slice:          "baseline",
		DefaultProfile: "execute",
		Description:    "Minimal daily-safe runtime",
		Aliases:        []string{"base", "safe"},
	},
	{
		Name:           "quick",
		Slice:          "baseline",
		DefaultProfile: "fast",
		Description:    "Quick unblock mode",
		Aliases:        []string{"fast"},
	},
}
