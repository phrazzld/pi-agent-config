...
3. If delegating to subagents, define success criteria + stop criteria up front. Prefer opinionated defaults over introducing extra runtime knobs unless absolutely required.
